...
// XXX: Using this (instead of NewFromApp) will cause panics
...
// XXX: We replace calls to this with LatestState
...
// TODO: subscribe to tendermint core
...
func (self *XEth) PushTx(encodedTx string) (string, error) {
	...
	// XXX: replaced with push to tendermint
...
func (self *XEth) Transact(fromStr, toStr, nonceStr, valueStr, gasStr, gasPriceStr, codeStr string) (string, error) {
	...
	*/
	...
	// XXX: replaced with broadcast tx to tendermint
	// if err = self.backend.TxPool().Add(signed); err != nil {
	if err = self.BroadcastTx(signed); err != nil {
		return "", err
	}
